...
#define PAMP_GPIO	(PM8921_GPIO_PM_TO_SYS(18))
...
static int __init jet_audio_init(void)
{
	...
	rc = gpio_request(PM8921_GPIO_PM_TO_SYS(JET_AUD_AMP_EN),
					"jet_en");

	rc = pm8xxx_gpio_config(PM8921_GPIO_PM_TO_SYS(JET_AUD_AMP_EN),
			&param);
...
MODULE_DESCRIPTION("ALSA Platform Tahiti");
